...
interface IBridgeGate {
    ...
    /// @dev Withdraw fees.
    /// @param _bridgeId Asset identifier.
    function withdrawFee(bytes32 _bridgeId) external;
    ...
    event CollectedFee(bytes32 bridgeId, uint32 referralCode, uint256 fee);
    event WithdrawnFee(bytes32 bridgeId, uint256 fee);
}
