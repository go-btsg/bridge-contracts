...
describe("CallProxy", function () {
  ...
  beforeEach(async function () {
    ...
    const Bridge_GATE_ROLE = await this.proxy.Bridge_GATE_ROLE();
    await this.proxy.grantRole(Bridge_GATE_ROLE, deployer.address);
  });
  ...
  describe("Cross-contract interaction", function () {
    ...
    beforeEach(async function () {
      ...
      const Bridge_GATE_ROLE = await this.proxy.Bridge_GATE_ROLE();
      await this.proxy.grantRole(Bridge_GATE_ROLE, this.ProxyConsumer.address);
    });
